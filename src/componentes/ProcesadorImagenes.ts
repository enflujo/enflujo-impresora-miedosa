export function procesadorImagenes() {
  ...
  // categorias[3]
  // cargarImagenes('horse', 15, 15, 'white', 'white');
  // async function leerTrayectos(nombre: string) {
  //   const codigo = (await import(`./gcodes/${nombre}?raw`)).default;
  //   console.log(codigo);
  // }
  ...
  function escalarImg(imagen: HTMLImageElement) {
    ...
    lienzo.width = ancho;
    lienzo.height = alto;
    lienzoImg.width = maximoX;
    lienzoImg.height = maximoY;
